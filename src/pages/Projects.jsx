...
const Projects = () => {
    const projects = [
        {
            id: 1,
            title: 'Serverless E-Commerce - AWS Cloud Architecture',
            description: 'Backend microservices system showcasing AWS serverless stack integration. Handles end-to-end order flow from API request through payment and fulfillment. Implements REST API with authentication, event-driven service coordination, NoSQL data modeling, and comprehensive monitoring. Features automatic retry logic, dead-letter queues for error handling, and detailed CloudWatch metrics for observability.',
            technologies: ['AWS Lambda', 'EventBridge', 'DynamoDB', 'API Gateway', 'Node.js', 'CloudWatch', 'SNS', 'SQS'],
            timeline: '01/2026',
            github: 'https://github.com/aattanasio/serverless-ecommerce-aws',
            // demo: 'https://your-demo-link' // Optional: add when you have video demo
        },
        {
            id: 2,
